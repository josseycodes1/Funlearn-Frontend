...
export default function DashboardSidebar({
  ...
  const menuItems = [
    { id: "overview", label: "Overview", icon: "◼️", path: "/dashboard" },
    { id: "chatbot", label: "AI Chat Bot", icon: "⚫", path: "/dashboard/chatbot" },
    { id: "quiz", label: "Take Quiz", icon: "🎱", path: "/dashboard/quizpage" },
    { id: "chatroom", label: "Chat Room", icon: "⚪", path: "/dashboard/chatroom" },
    { id: "leaderboard", label: "Leaderboard", icon: "⬜", path: "/dashboard/leaderboard" },
    { id: "profile", label: "Profile", icon: "⬛", path: "/dashboard/profile-settings" },
  ];
