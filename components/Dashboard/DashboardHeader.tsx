    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4">
        <div className="flex items-center space-x-3 md:space-x-4">
          ...
          {/* FunLearn Logo for larger screens - Hidden on mobile */}
          <button
            onClick={handleGoToHomepage}
            className="hidden md:flex items-center space-x-2 px-3 py-2 bg-funlearn6 text-white rounded-lg font-semibold hover:bg-funlearn7 transition-colors"
          >
            <span>FunLearn</span>
          </button>
      ...
      <div className={`fixed top-0 left-0 h-full w-4/5 max-w-sm bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 md:hidden ${
        ...
        {/* Header with FunLearn logo and close button */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          {/* FunLearn Logo for mobile */}
          <button
            onClick={() => {
              handleGoToHomepage();
              setMobileMenuOpen(false);
            }}
            className="flex items-center space-x-2 px-3 py-2 bg-funlearn6 text-white rounded-lg font-semibold hover:bg-funlearn7 transition-colors"
          >
            <span>FunLearn</span>
          </button>
          ...
          {/* Close button */}
          <div 
            className="text-purple-600 text-2xl cursor-pointer p-2"
