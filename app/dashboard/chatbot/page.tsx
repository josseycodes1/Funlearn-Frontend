...
export default function ChatBotPage() {
  ...
  return (
    <div className="flex h-full bg-white">
      {/* Chat History Sidebar - FIXED: No overlay, just slides in/out */}
      <div
        className={`
      ...
      {/* Main Chat Area - FIXED: No bottom margin, proper height */}
      <div className="flex-1 flex flex-col min-w-0 h-full">
        ...
        <div className="flex items-center justify-between p-4 lg:p-6 border-b border-gray-200 bg-white shrink-0">
          ...
          <div className="flex items-center space-x-3">
            {/* Generate Quiz Button with Tooltip */}
            {currentChatId && (
              <div className="relative group">
                ...
                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap sm:hidden">
                  Generate Quiz
                </div>
              </div>
            )}
        ...
        {/* Messages Area - FIXED: No bottom margin */}
        <div className="flex-1 overflow-y-auto bg-gray-50">
          {messages.length === 0 ? (
            <div className="h-full flex items-center justify-center p-4 lg:p-8">
              <div className="text-center max-w-md">
                <div className="w-16 h-16 lg:w-20 lg:h-20 bg-funlearn2 rounded-full flex items-center justify-center mx-auto mb-4 lg:mb-6">
                  <svg
                    className="w-8 h-8 lg:w-10 lg:h-10 text-funlearn8"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="p-3 bg-white rounded-lg border border-gray-200">
                    ...
                    <div className="text-gray-600 text-xs">Analyze documents</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 lg:p-6 space-y-4 lg:space-y-6">
              {messages.map((message) => (
                ...
                >
                  <div
                    className={`max-w-xs sm:max-w-sm md:max-w-2xl rounded-2xl px-4 py-3 lg:px-6 lg:py-4 ${
                      message.role === "user"
        ...
        {/* Input Area - FIXED: No extra margin */}
        <div className="border-t border-gray-200 bg-white p-4 lg:p-6 shrink-0">
          ...
          {uploadedFileName && (
            <div className="mb-4 flex items-center justify-between p-3 bg-funlearn2 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-funlearn8 truncate max-w-[200px] sm:max-w-none">
                  {uploadedFileName}
                </span>
              </div>
              <button
                onClick={removeFile}
                className="p-1 hover:bg-funlearn4 rounded transition-colors shrink-0"
              >
                <svg
          ...
          <form onSubmit={handleSendMessage} className="flex space-x-3 lg:space-x-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center px-3 lg:px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 shrink-0"
            >
              <svg
            ...
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-funlearn6 focus:border-funlearn6 transition-colors text-gray-900 placeholder-gray-500 text-sm lg:text-base"
              disabled={isLoading}
            />
            ...
            <button
              ...
              className="px-4 lg:px-6 py-3 bg-funlearn6 text-white rounded-lg font-medium hover:bg-funlearn7 focus:ring-2 focus:ring-funlearn6 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shrink-0 text-sm lg:text-base"
            >
              {isLoading ? (
